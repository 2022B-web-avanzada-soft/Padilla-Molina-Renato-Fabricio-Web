...
import CriptoFormulario from "../components/f_ejemplo_cripto/CriptoFormulario";
                    ...
                    <div className="col-sm-6">
                        {
                            resultado.PRICE &&
                            <div>
                                <p><strong>PRICE: </strong>{resultado.PRICE}</p>
                                ...
                                <p><strong>Ultima actuaizacion: </strong>{resultado.LASTUPDATE}</p>
                            </div>
                        }
                    </div>
                </div>
